...
Object.defineProperty(exports, "__esModule", { value: true });
const path = __webpack_require__(/*! path */ "path");
const electron_utils_1 = __webpack_require__(/*! ./utils/electron-utils */ "./src/main/utils/electron-utils.ts");
const electron_1 = __webpack_require__(/*! electron */ "electron");
const mainProcessStore_1 = __webpack_require__(/*! ./mainProcessStore */ "./src/main/mainProcessStore.ts");
const redux_app_focus_1 = __webpack_require__(/*! ../shared/state/redux-app-focus */ "./src/shared/state/redux-app-focus.ts");
const redux_window_state_1 = __webpack_require__(/*! ../shared/state/redux-window-state */ "./src/shared/state/redux-window-state.ts");
const ui_menu_item_1 = __webpack_require__(/*! ../shared/menu/ui-menu-item */ "./src/shared/menu/ui-menu-item.ts");
const menu_commands_1 = __webpack_require__(/*! ../shared/menu/menu-commands */ "./src/shared/menu/menu-commands.ts");
...
class AppWindow {
    ...
    constructor() {
        ...
        if (!windowStateKeeper) {
            windowStateKeeper = __webpack_require__(/*! electron-window-state */ "./node_modules/electron-window-state/index.js");
        }
        ...
        if (electron_utils_1.__DARWIN__) {
            windowOptions.titleBarStyle = "hidden";
        }
        else if (electron_utils_1.__WIN32__) {
            // TODO: Set it to false when menu proxy is ready
            windowOptions.frame = true;
        }
        else if (electron_utils_1.__LINUX__) {
            windowOptions.icon = path.join(__dirname, "static", "icon-logo.png");
        }
        this._window = new electron_1.BrowserWindow(windowOptions);
        redux_window_state_1.setAppWindow(this);
        // --- Set up main window events
        this._window.on("focus", () => {
            mainProcessStore_1.mainProcessStore.dispatch(redux_app_focus_1.appGotFocusAction());
        });
        this._window.on("blur", () => {
            mainProcessStore_1.mainProcessStore.dispatch(redux_app_focus_1.appLostFocusAction());
        });
        ...
        this.window.on("leave-full-screen", () => {
            mainProcessStore_1.mainProcessStore.dispatch(redux_window_state_1.restoreAppWindowAction());
        });
        this.window.on("maximize", () => {
            mainProcessStore_1.mainProcessStore.dispatch(redux_window_state_1.maximizeAppWindowAction());
        });
        this.window.on("minimize", () => {
            mainProcessStore_1.mainProcessStore.dispatch(redux_window_state_1.minimizeAppWindowAction());
        });
    ...
    load() {
        let watcher;
        if (electron_utils_1.__DEV__) {
            // --- Indev mode, setup hot reload
            const fileToWatch = path.join(__dirname, "./renderer.bundle.js");
            watcher = __webpack_require__(/*! chokidar */ "./node_modules/chokidar/index.js").watch(fileToWatch, { ignoreInitial: true });
     ...
     */
    setupMenu() {
        const aboutGroup = new ui_menu_item_1.UiMenuItem().append(new menu_commands_1.AboutCommand());
        const prefsGroup = new ui_menu_item_1.UiMenuItem().append(new menu_commands_1.OptionsCommand());
        const servicesGroup = new ui_menu_item_1.UiMenuItem().append(new ui_menu_item_1.ElectronShellMenuItem("services"));
        const appWindowGroup = new ui_menu_item_1.UiMenuItem()
            .append(new ui_menu_item_1.ElectronShellMenuItem("hide"))
            .append(new ui_menu_item_1.ElectronShellMenuItem("hideOthers"))
            .append(new ui_menu_item_1.ElectronShellMenuItem("unhide"));
        const quitGroup = new ui_menu_item_1.UiMenuItem().append(new ui_menu_item_1.ElectronShellMenuItem("quit", electron_utils_1.__DARWIN__ ? undefined : "E&xit"));
        const darwinMenu = new ui_menu_item_1.UiMenuItem("darwin", "ZX Spectrum IDE")
            .append(aboutGroup)
            .append(prefsGroup)
            .append(servicesGroup)
            .append(appWindowGroup)
            .append(quitGroup);
        const createGroup = new ui_menu_item_1.UiMenuItem()
            .append(new menu_commands_1.NewProjectCommand())
            .append(new menu_commands_1.OpenProjectCommand());
        const closeGroup = new ui_menu_item_1.UiMenuItem().append(new menu_commands_1.CloseProjectCommand());
        const fileMenu = new ui_menu_item_1.UiMenuItem("file", electron_utils_1.__DARWIN__ ? "File" : "&File")
            .append(createGroup)
            .append(closeGroup);
        if (!electron_utils_1.__DARWIN__) {
        ...
        const explorerGroup = new ui_menu_item_1.UiMenuItem()
            .append(new menu_commands_1.ShowExplorerCommand())
            .append(new menu_commands_1.ShowSpectrumEmulatorCommand());
        const spectrumWindowsGroup = new ui_menu_item_1.UiMenuItem()
            .append(new menu_commands_1.ShowRegistersCommand())
            .append(new menu_commands_1.ShowDisassemblyCommand())
            .append(new menu_commands_1.ShowMemoryCommand());
        const devToolGroup = new ui_menu_item_1.UiMenuItem().append(new menu_commands_1.ToggleDevToolsCommand());
        const viewMenu = new ui_menu_item_1.UiMenuItem("view", electron_utils_1.__DARWIN__ ? "View" : "&View")
            .append(explorerGroup)
            .append(spectrumWindowsGroup)
            .append(devToolGroup);
        const help1Group = new ui_menu_item_1.UiMenuItem()
            .enable(false)
            .append(new ui_menu_item_1.UiMenuItem("help-topic-1", "Help topic #1"))
            .append(new ui_menu_item_1.UiMenuItem("help-topic-2", "Help topic #2"));
        const help3SubGroup = new ui_menu_item_1.UiMenuItem("help-topic-3", "Help topic #&3")
            .append(new ui_menu_item_1.UiMenuItem("help-topic-31", "Help topic #31"))
            .append(new ui_menu_item_1.UiMenuItem("help-topic-32", "Help topic #32"))
            .append(new ui_menu_item_1.UiMenuItem("help-topic-33", "Help topic #33"));
        const help4SubGroup = new ui_menu_item_1.UiMenuItem("help-topic-4", "Help topic #&4")
            .append(new ui_menu_item_1.UiMenuItem("help-topic-41", "Help topic #41"))
            .append(new ui_menu_item_1.UiMenuItem("help-topic-42", "Help topic #42"))
            .append(new ui_menu_item_1.UiMenuItem("help-topic-43", "Help topic #43"));
        const help2Group = new ui_menu_item_1.UiMenuItem()
            .append(help3SubGroup)
            .append(help4SubGroup);
        const helpMenu = new ui_menu_item_1.UiMenuItem("help", electron_utils_1.__DARWIN__ ? "Help" : "H&elp")
            .append(help1Group)
            .append(help2Group);
        const menuCommands = new ui_menu_item_1.UiMenuItem();
        if (electron_utils_1.__DARWIN__) {
        ...
        this._appMenu = electron_1.Menu.buildFromTemplate(template);
        electron_1.Menu.setApplicationMenu(this._appMenu);
        mainProcessStore_1.mainProcessStore.dispatch(redux_menu_state_1.setAppMenuAction(this._appCommands));
     ...
     */
    buildDefaultMenuFromCommands(commands) {
        const topItems = [];
        commands.items.forEach(item => {
            ...
            if (item.items.length === 0) {
                throw new Error("Top level command item must have at least one subcommand.");
            }
     ...
     * @param menuGroup
     */
    buildMenuPaneFromCommands(menuGroup) {
        ...
        for (let i = 0; i < menuGroup.items.length; i++) {
            ...
            if ((i > 0 && subitem.items.length > 0 !== lastItemWasGroup) ||
                groupJustEnded) {
                pane.push(separator);
            }
...
Object.defineProperty(exports, "__esModule", { value: true });
const electron_1 = __webpack_require__(/*! electron */ "electron");
const AppWindow_1 = __webpack_require__(/*! ./AppWindow */ "./src/main/AppWindow.ts");
...
function setupAppWindow() {
    mainWindow = new AppWindow_1.AppWindow();
...
electron_1.app.on("ready", setupAppWindow);
...
const store = redux_1.createStore(spectNetApp, defaultState, redux_1.applyMiddleware(redux_core_1.triggerAlias, redux_core_1.forwardToRenderer));
redux_core_1.replayActionMain(store);
/**
 * This is the store we can use in the main process
 */
exports.mainProcessStore = store;
/**
 * Creates an object that is aware about the main process store's state
 * @param propName AppState property name
 */
exports.createMainProcessStateAware = (propName = null) => new StateAwareObject_1.StateAwareObject(exports.mainProcessStore, propName);
...
/***/ "./src/shared/menu/menu-commands.ts":
/*!******************************************!*\
  !*** ./src/shared/menu/menu-commands.ts ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const ui_menu_item_1 = __webpack_require__(/*! ./ui-menu-item */ "./src/shared/menu/ui-menu-item.ts");
const electron_utils_1 = __webpack_require__(/*! ../../main/utils/electron-utils */ "./src/main/utils/electron-utils.ts");
class AboutCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
...
class OptionsCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("show-preferences", electron_utils_1.__DARWIN__ ? "Preferences..." : "O&ptions...");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
...
class NewProjectCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("create-project", electron_utils_1.__DARWIN__ ? "New Project..." : "&New project...");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
...
class OpenProjectCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("open-project", electron_utils_1.__DARWIN__ ? "Open Project..." : "&Open project...");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
...
class CloseProjectCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("close-project", electron_utils_1.__DARWIN__ ? "Close Project" : "Close project");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.CloseProjectCommand = CloseProjectCommand;
class ShowExplorerCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("show-project", electron_utils_1.__DARWIN__ ? "Show Explorer" : "Show explorer");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.ShowExplorerCommand = ShowExplorerCommand;
class ShowSpectrumEmulatorCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("show-spectrum-emulator", electron_utils_1.__DARWIN__ ? "ZX Spectrum Emulator" : "ZX Spectrum emulator");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.ShowSpectrumEmulatorCommand = ShowSpectrumEmulatorCommand;
class ShowRegistersCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("show-registers", electron_utils_1.__DARWIN__ ? "Z80 Registers" : "Z80 registers");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.ShowRegistersCommand = ShowRegistersCommand;
class ShowDisassemblyCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("show-disassembly", electron_utils_1.__DARWIN__ ? "Z80 Disassembly" : "Z80 disassembly");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.ShowDisassemblyCommand = ShowDisassemblyCommand;
class ShowMemoryCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("show-memory", electron_utils_1.__DARWIN__ ? "ZX Spectrum Memory" : "ZX Spectrum memory");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.ShowMemoryCommand = ShowMemoryCommand;
class ToggleDevToolsCommand extends ui_menu_item_1.UiMenuItem {
    constructor() {
        super("toggle-dev-tools", electron_utils_1.__DARWIN__ ? "Toggle Developer Tools" : "&Toggle developer tools");
    }
    onExecute(window) {
        // TODO: Implement this command
    }
}
exports.ToggleDevToolsCommand = ToggleDevToolsCommand;
